...
DESIRED_COLUMN_INFO = {
    ...
    'properties.properties.street': 'says which street/road name the jam is on, will extract interstate number',
    'properties.day_of_the_week': 'day of the week the jam occurs on, 0 - 6, 0 = monday',
    'properties.weekend_weekday': 'if it is a weekend = True, weekday  = False',
    ...
    'RoadwayCha': 'tells if road has slope and/or curve, split into curve and grade columns, use hot encoding',
    ...
    'Interseti': 'not, related, or at intersection, can use ordinal encoding',
    'CountyName': 'country name, would need full encoding',
    'CityTownName': 'name of city/town, would need full encoding',
